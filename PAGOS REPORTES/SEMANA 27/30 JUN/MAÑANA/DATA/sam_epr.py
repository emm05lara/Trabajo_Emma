...
fecha_inicio = datetime.strptime('23/06/2025', '%d/%m/%Y').date()
fecha_fin = datetime.strptime('29/06/2025', '%d/%m/%Y').date()
...
cuentas_por_segmento = {
    'Extrajudicial - 0 a 28 semanas de atraso': 3862,
    'Extrajudicial - 29 a 39 semanas de atraso': 4122,
    'Extrajudicial - 40 a 55 semanas de atraso': 6894,
    'Mas 55 semanas de atraso': 15493
}
