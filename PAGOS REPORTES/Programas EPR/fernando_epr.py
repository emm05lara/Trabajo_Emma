...
# --- 1. CARGA DE DATOS ---
df = pd.read_excel('fernando.xlsx', sheet_name='Pagos Despacho 60496')
...
cuentas_por_segmento = {
    'Extrajudicial - 0 a 28 semanas de atraso': 1227,
    'Extrajudicial - 29 a 39 semanas de atraso': 0,
    'Extrajudicial - 40 a 55 semanas de atraso': 0,
    'Mas 55 semanas de atraso': 0
}

epr_ideal = {
    'Extrajudicial - 0 a 28 semanas de atraso': 92,
    'Extrajudicial - 29 a 39 semanas de atraso': 0,
    'Extrajudicial - 40 a 55 semanas de atraso': 0,
    'Mas 55 semanas de atraso': 0
}
