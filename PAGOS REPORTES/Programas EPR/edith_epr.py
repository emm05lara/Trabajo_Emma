...
# --- 1. CARGA DE DATOS ---
df = pd.read_excel('edith.xlsx', sheet_name='Pagos Despacho 60833')
...
cuentas_por_segmento = {
    'Extrajudicial - 0 a 28 semanas de atraso': 2295,
    'Extrajudicial - 29 a 39 semanas de atraso': 411,
    'Extrajudicial - 40 a 55 semanas de atraso': 1345,
    'Mas 55 semanas de atraso': 12069
}

epr_ideal = {
    'Extrajudicial - 0 a 28 semanas de atraso': 227,
    'Extrajudicial - 29 a 39 semanas de atraso': 409,
    'Extrajudicial - 40 a 55 semanas de atraso': 41,
    'Mas 55 semanas de atraso': 8
}
