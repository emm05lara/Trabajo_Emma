...
# --- 1. CARGA DE DATOS ---
df = pd.read_excel('sofia.xlsx', sheet_name='Pagos Despacho 60543')
...
cuentas_por_segmento = {
    'Extrajudicial - 0 a 28 semanas de atraso': 569,
    'Extrajudicial - 29 a 39 semanas de atraso': 407,
    'Extrajudicial - 40 a 55 semanas de atraso': 307,
    'Mas 55 semanas de atraso': 711
}

epr_ideal = {
    'Extrajudicial - 0 a 28 semanas de atraso': 397,
    'Extrajudicial - 29 a 39 semanas de atraso': 345,
    'Extrajudicial - 40 a 55 semanas de atraso': 165,
    'Mas 55 semanas de atraso': 39
}
