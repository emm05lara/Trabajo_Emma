...
# --- 1. CARGA DE DATOS ---
df = pd.read_excel('andrea.xlsx', sheet_name='Pagos Despacho 60050')
...
cuentas_por_segmento = {
    'Extrajudicial - 0 a 28 semanas de atraso': 1901,
    'Extrajudicial - 29 a 39 semanas de atraso': 1300,
    'Extrajudicial - 40 a 55 semanas de atraso': 3520,
    'Mas 55 semanas de atraso': 18239
}

epr_ideal = {
    'Extrajudicial - 0 a 28 semanas de atraso': 180,
    'Extrajudicial - 29 a 39 semanas de atraso': 91,
    'Extrajudicial - 40 a 55 semanas de atraso': 35,
    'Mas 55 semanas de atraso': 21
}
