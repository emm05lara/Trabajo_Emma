...
# --- 1. CARGA DE DATOS ---
df = pd.read_excel('olguin.xlsx', sheet_name='Pagos Despacho 61023')
...
cuentas_por_segmento = {
    'Extrajudicial - 0 a 28 semanas de atraso': 809,
    'Extrajudicial - 29 a 39 semanas de atraso': 694,
    'Extrajudicial - 40 a 55 semanas de atraso': 1001,
    'Mas 55 semanas de atraso': 368
}

epr_ideal = {
    'Extrajudicial - 0 a 28 semanas de atraso': 186,
    'Extrajudicial - 29 a 39 semanas de atraso': 40,
    'Extrajudicial - 40 a 55 semanas de atraso': 28,
    'Mas 55 semanas de atraso': 85
}
